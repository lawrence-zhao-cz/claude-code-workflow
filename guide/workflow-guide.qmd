...
| `/test-reviewers` | `.claude/skills/test-reviewers/` | Behavioral regression suite for the reviewer/auditor agent layer — seeded-defect fixtures re-run through each gate blind, forked different-tier judge grades defect-naming, N=3 catch-rate vs baseline; signal not gate (v2.1) |
